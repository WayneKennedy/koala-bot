...
Figures with a matching STL hash are **slicer estimates** using the recorded PETG/TPU review settings (`docs/design/manufacturing/slices.json`); changed or unsliced parts fall back to a labelled solid-geometry upper bound. All structural parts printed solid would be 839 g.

| Part | Qty | Printable | Material | Size (mm) | Filament | Print time | Print notes |
|------|-----|-----------|----------|-----------|----------|-----------|-------------|
| `e_tray` | 1 | assumed | PETG | 96 x 88 x 9 | ~43 g (solid max) | - | clean |
...
| `hip_carrier_left` | 1 | unknown | PETG | 45 x 78 x 51 | ~46 g (solid max) | - | 282 mm2 flagged overhang; inspect slice |
| `hip_carrier_right` | 1 | unknown | PETG | 45 x 78 x 51 | ~46 g (solid max) | - | 282 mm2 flagged overhang; inspect slice |
| `root_socket_left` | 2 | unknown | PETG | 47 x 37 x 28 | ~60 g (solid max) | - | 70 mm2 flagged overhang; inspect slice |
| `root_socket_right` | 2 | unknown | PETG | 47 x 37 x 28 | ~60 g (solid max) | - | 70 mm2 flagged overhang; inspect slice |
| `shank_left` | 1 | unknown | PETG | 123 x 46 x 51 | ~47 g (solid max) | - | 2241 mm2 flagged overhang; inspect slice |
| `shank_right` | 1 | unknown | PETG | 123 x 46 x 51 | ~47 g (solid max) | - | 2241 mm2 flagged overhang; inspect slice |
| `shoulder_carrier_left` | 1 | assumed | PETG | 45 x 88 x 51 | ~50 g (solid max) | - | 331 mm2 flagged overhang; inspect slice |
| `shoulder_carrier_right` | 1 | assumed | PETG | 45 x 88 x 51 | ~50 g (solid max) | - | 331 mm2 flagged overhang; inspect slice |
| `thigh_left` | 1 | unknown | PETG | 45 x 110 x 73 | ~53 g (solid max) | - | brim (tall, small footprint); 2742 mm2 flagged overhang; inspect slice |
| `thigh_right` | 1 | unknown | PETG | 45 x 110 x 73 | ~53 g (solid max) | - | brim (tall, small footprint); 2742 mm2 flagged overhang; inspect slice |
| `torso_frame` | 1 | assumed | PETG | 58 x 80 x 66 | ~90 g (solid max) | - | 1084 mm2 flagged overhang; inspect slice |
...
| **Structural total** | **24** | | | | **~839 g (solid max)** | **-** | |
