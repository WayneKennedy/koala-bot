...
Figures with a matching STL hash are **slicer estimates** using the recorded PETG/TPU review settings (`docs/design/manufacturing/slices.json`); changed or unsliced parts fall back to a labelled solid-geometry upper bound. All structural parts printed solid would be 871 g.
...
| `forearm_left` | v1 | 1 | assumed | PETG | 49 x 113 x 21 | 30 g | 2h 59m 46s | 1375 mm2 flagged overhang; inspect slice |
| `forearm_right` | v1 | 1 | assumed | PETG | 49 x 113 x 21 | 30 g | 2h 59m 52s | 1375 mm2 flagged overhang; inspect slice |
...
| `root_socket_left` | v1 | 2 | assumed | PETG | 47 x 37 x 28 | ~60 g (solid max) | - | 70 mm2 flagged overhang; inspect slice |
| `root_socket_right` | v1 | 2 | assumed | PETG | 47 x 37 x 28 | ~60 g (solid max) | - | 70 mm2 flagged overhang; inspect slice |
...
| `shoulder_carrier_left` | v1 | 1 | assumed | PETG | 45 x 88 x 51 | ~50 g (solid max) | - | 331 mm2 flagged overhang; inspect slice |
| `shoulder_carrier_right` | v1 | 1 | assumed | PETG | 45 x 88 x 51 | ~50 g (solid max) | - | 331 mm2 flagged overhang; inspect slice |
| `thigh_left` | v2 | 1 | assumed | PETG | 45 x 110 x 73 | ~58 g (solid max) | - | 1892 mm2 flagged overhang; inspect slice |
| `thigh_right` | v2 | 1 | assumed | PETG | 45 x 110 x 73 | ~58 g (solid max) | - | 1892 mm2 flagged overhang; inspect slice |
| `torso_frame` | v3 | 1 | assumed | PETG | 85 x 84 x 66 | ~114 g (solid max) | - | 1908 mm2 flagged overhang; inspect slice |
| `tray_spacer` | v1 | 4 | assumed | PETG | 7 x 7 x 4 | 1 g | 2m 35s | small contact area; brim / grouped placement |
| `upper_arm_left` | v1 | 1 | assumed | PETG | 45 x 62 x 49 | 36 g | 3h 20m 52s | 2153 mm2 flagged overhang; inspect slice |
| `upper_arm_right` | v1 | 1 | assumed | PETG | 45 x 62 x 49 | 36 g | 3h 21m 0s | 2153 mm2 flagged overhang; inspect slice |
...
| `coupon_socket_fork` | v1 | 1 | assumed | PETG | 42 x 21 x 49 | 19 g | 1h 45m 3s | 568 mm2 flagged overhang; inspect slice |
| `coupon_socket_saddle` | v1 | 1 | assumed | PETG | 45 x 29 x 22 | 16 g | 1h 36m 50s | 70 mm2 flagged overhang; inspect slice |
| **Structural total** | | **24** | | | | **~871 g (solid max)** | **-** | |
