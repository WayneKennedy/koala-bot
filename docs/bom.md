...
Filament and time are **measured**, by slicing each STL with the standing PETG profile on the print host (`koala_hardware.slice_remote`). For scale, the same parts printed *solid* would be 857 g — infill is doing its job.
...
| `hip_link_left` | 1 | 66 x 61 x 57 | 28 g | 3h 6m 10s | 388 mm2 self-supporting overhang |
| `hip_link_right` | 1 | 66 x 61 x 57 | 28 g | 3h 6m 16s | 388 mm2 self-supporting overhang |
...
| `thigh_upper_left` | 1 | 107 x 72 x 30 | 47 g | 3h 45m 48s | 468 mm2 self-supporting overhang |
| `thigh_upper_right` | 1 | 107 x 72 x 30 | 47 g | 3h 46m 5s | 468 mm2 self-supporting overhang |
