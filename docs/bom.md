...
Figures with a matching STL hash are **slicer estimates** using the recorded PETG/TPU review settings (`docs/design/manufacturing/slices.json`); changed or unsliced parts fall back to a labelled solid-geometry upper bound. All structural parts printed solid would be 858 g.
...
| **Structural total** | **24** | | | | **~858 g (solid max)** | **-** | |
