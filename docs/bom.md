...
Filament and time are **measured**, by slicing each STL with the standing PETG profile on the print host (`koala_hardware.slice_remote`). For scale, the same parts printed *solid* would be 689 g — infill is doing its job.
...
| `hip_link_left` | 1 | 50 x 30 x 89 | 28 g | 3h 6m 10s | brim (tall, small footprint); 689 mm2 self-supporting overhang |
| `hip_link_right` | 1 | 50 x 30 x 89 | 28 g | 3h 6m 16s | brim (tall, small footprint); 689 mm2 self-supporting overhang |
...
| `thigh_upper_left` | 1 | 107 x 50 x 30 | 47 g | 3h 45m 48s | 455 mm2 self-supporting overhang |
| `thigh_upper_right` | 1 | 107 x 50 x 30 | 47 g | 3h 46m 5s | 455 mm2 self-supporting overhang |
